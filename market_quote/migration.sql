CREATE TABLE market_quotation (id INTEGER NOT NULL, uuid VARCHAR(32) NOT NULL, source VARCHAR(32) NOT NULL,quotation JSON NOT NULL, create_time DATETIME,PRIMARY KEY (id));
